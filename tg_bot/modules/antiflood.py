...
@loggable
async def check_flood(update: Update, context) -> str:
    ...
    try:
        ...
        await msg.reply_text("ഫ്ലഡ് ചെയ്യുന്നോ... നിങ്ങൾക്കായി ഒരു കണ്ടം ഒരുക്കിയിട്ടുണ്ട്...  "
                             "ഒന്ന് ഓടിയിട്ട് വരൂ...")
...
@can_restrict
@loggable
async def set_flood(update: Update, context, args: List[str] = None) -> str:
    if args is None:
...
async def flood(update: Update, context):
    chat = update.effective_chat
