...
async def about_me(update: Update, context, args: List[str] = None):
    if args is None:
...
async def set_about_me(update: Update, context):
    message = update.effective_message
...
async def about_bio(update: Update, context, args: List[str] = None):
    if args is None:
        args = context.args or []
    message = update.effective_message
...
async def set_about_bio(update: Update, context):
    message = update.effective_message
